 ...
 *
 */
public class BunnyBotAutoRight extends CommandGroup {

	public BunnyBotAutoRight() {
		// Add Commands here:
		...
		addSequential(new DriveDistanceCommand(15.0, 0.0, 0.3), 3.0); // forward 15 feet
		addSequential(new RotateCommand(45.0, 0.3));
